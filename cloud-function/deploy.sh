...
gcloud functions deploy $FUNCTION_NAME \
  ...
  --set-env-vars="GOOGLE_CLOUD_PROJECT=instame-470206,SUPABASE_URL=${SUPABASE_URL},SUPABASE_SERVICE_ROLE_KEY=${SUPABASE_SERVICE_ROLE_KEY},GEMINI_API_KEY=${GEMINI_API_KEY},SESSION_ID=${SESSION_ID},EVALUATION_CRITERIA=${EVALUATION_CRITERIA:-comprehensive},EVALUATION_MODE=${EVALUATION_MODE:-reference_comparison}" \
